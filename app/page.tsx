...
export const metadata: Metadata = {
  title: "Free AI Resume Builder | Create Professional Resumes Online | ResumeAI",
  description:
    "Build professional, ATS-friendly resumes with our free AI resume builder. Get job-specific optimization, professional templates, and land more interviews. Start building your resume today!",
  keywords:
    "free resume builder, AI resume generator, professional resume maker, ATS resume builder, job application resume, resume templates, CV builder online",
  openGraph: {
      ...
      <main>
        <section className="py-24 px-4 relative overflow-hidden">
          ...
          <div className="container mx-auto max-w-4xl text-center relative z-10">
            <h2 className="text-6xl font-serif font-bold mb-6 text-white">Free AI Resume Builder</h2>
            <p className="text-xl mb-8 text-white/90 leading-relaxed max-w-2xl mx-auto">
              Create professional, ATS-optimized resumes in minutes with our free AI resume builder. Analyze job
              descriptions and tailor your resume for maximum impact and more interviews.
            </p>
        ...
        <section className="py-20 px-4" aria-labelledby="features-heading">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-16">
              <h3 id="features-heading" className="text-4xl font-serif font-bold mb-4 text-foreground">
                Why Choose Our AI Resume Builder?
              </h3>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Our AI-powered resume builder helps you create resumes that get noticed by employers and pass ATS
                systems with professional templates and job-specific optimization.
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              <article className="glass p-8 rounded-2xl border border-white/20 text-center">
                <Zap className="h-12 w-12 text-primary mx-auto mb-4" />
                <h4 className="text-xl font-semibold mb-3">AI-Powered Resume Optimization</h4>
              ...
              <article className="glass p-8 rounded-2xl border border-white/20 text-center">
                ...
                <h4 className="text-xl font-semibold mb-3">ATS-Friendly Resume Templates</h4>
                <p className="text-muted-foreground">
                  All resume templates are designed to pass Applicant Tracking Systems and reach human recruiters
                  successfully.
                </p>
              </article>
              <article className="glass p-8 rounded-2xl border border-white/20 text-center">
                <Shield className="h-12 w-12 text-primary mx-auto mb-4" />
                <h4 className="text-xl font-semibold mb-3">Professional Resume Templates</h4>
                <p className="text-muted-foreground">
                  Choose from expertly designed professional resume templates that make a great first impression with
                  employers.
                </p>
              </article>
            </div>
        ...
        <section className="py-20 px-4 glass border-y border-white/10" aria-labelledby="testimonials-heading">
          <div className="container mx-auto max-w-4xl text-center">
            <h3 id="testimonials-heading" className="text-4xl font-serif font-bold mb-16 text-foreground">
        ...
        <section className="py-20 px-4" aria-labelledby="pricing-heading">
          <div className="container mx-auto max-w-4xl text-center">
            <h3 id="pricing-heading" className="text-4xl font-serif font-bold mb-8 text-foreground">
              Free Resume Builder with Premium Options
            </h3>
