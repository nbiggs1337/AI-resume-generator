...
import { Plus, FileText, Brain, Settings, BarChart3, Briefcase, Sparkles, Eye, Edit } from "lucide-react"
...
export default function DashboardClient({
  ...
  const [activeTab, setActiveTab] = useState("resumes") // Added tab state management
